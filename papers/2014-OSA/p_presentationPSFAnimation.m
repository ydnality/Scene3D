...
nLines = 10; %false;      % Number of lines to draw for debug illustrations.
...
for ff = 1:nFH
    for dd = 1:nDepth
        film = pbrtFilmC('position', [fX fY fZ], ...
            'size', [fW fH], ...
            'wave', wave, ...
        ...
        smallFilm = pbrtFilmC('position', [centroid.X centroid.Y fZ], ...
...
lineStruct = [];
lineStruct.spacing = 'uniform';
lineStruct.numLines = 65;
psfCamera.draw(true,lineStruct);
