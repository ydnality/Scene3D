...
pointSources = [ 100 0 -pointSourceDepth];  %large distance test
...
pointSourceDepth = 20000;
pointSourceFieldHeight = 0;
pointSources = [ 120 0 -pointSourceDepth];  %large distance test
% pointSources = [ 0 0 -60];  %short distance test
...
pointSourceDepth = 20000;
pointSourceFieldHeight = 0;
pointSources = [ 110 0 -pointSourceDepth];  %large distance test
% pointSources = [ 0 0 -60];  %short distance test
