...
% oi = s3dRenderSceneFast('../../autofocus/cones/autofocusTest.pbrt');
...
filepath = '/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/autofocusTest.pbrt';

% -----copy a temp .pbrt file-----
% -----create a old_temp.pbrt file
copyfile(filepath,'/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/old_temp.pbrt');
...
fid = fopen('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/old_temp.pbrt','r'); % open .pbrt file
nfid = fopen('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/new_temp.pbrt','w');
while ~feof(fid)
...
delete('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/old_temp.pbrt');
copyfile('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/new_temp.pbrt','/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/old_temp.pbrt');
delete('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/new_temp.pbrt');
% -----END-----
...
while ~feof(fid)
     ...
     if xresfind ~= 0
         xres = sscanf(tline,'%*s %*s %d'); % get the xreselution (int)
         tline = regexprep(tline, num2str(xres), '120'); % replace original xresolution
         fprintf(nfid,'%s',tline);
     elseif yresfind ~= 0
         yres = sscanf(tline,'%*s %*s %d'); % get the xreselution (int)
         tline = regexprep(tline, num2str(yres),'80'); % replace original crowwindow
         fprintf(nfid,'%s',tline);     
     elseif cwfind ~= 0
         %orig_cw = sscanf(tline,'%*s %*s %*s %d %d %d %d'); % get cropwindow parameter [xmin xmax ymin ymax]
...
for n=fdmin:.1:fdmax
    ...
    [fid, msg] = fopen('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/old_temp.pbrt','r'); % open .pbrt file
    [nfid, nmsg] = fopen('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/new_temp.pbrt','w');
    ...
    %delete(filepath);
    copyfile('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/new_temp.pbrt','/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/old_temp.pbrt');
    %copyfile('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/new_temp.pbrt',filepath');
    delete('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/new_temp.pbrt');
    % -----END-----
    
    sceneName = 'cones autofocus';
    oi = s3dRenderSceneFast('../../autofocus/cones/old_temp.pbrt');
    oi = oiSet(oi, 'name', sceneName);
    % vcAddAndSelectObject(oi);
    % oiWindow;
...
% -----replace old_temp.pbrt with new_temp.pbrt
delete(filepath);
copyfile('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/old_temp.pbrt',filepath);
delete('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/old_temp.pbrt');
delete('/home/ajwandell/Dropbox/Scene3D/Scene3DMatlab/autofocus/cones/new_temp.pbrt');
% -----END-----
...
sceneName = 'cones autofocus';
newoi = s3dRenderSceneFast('../../autofocus/cones/autofocusTest.pbrt');
newoi = oiSet(newoi, 'name', sceneName);
% vcAddAndSelectObject(oi);
% oiWindow;
showImage = oiGet(newoi, 'rgb image');
figure; imshow(showImage);
toc;
opFilmdis
