...
% Compute plenoptic point spread function
%
...
% returns light-field information in the form of the light fields at 
%  x: the input  pupil  ?? Use inLF
%  b: the exit pupil    ?? Use exLF
%  bMiddle: the middle aperture light-fields ?? midLF
%
% the ppsf, and the ppsfCamera used for the
% calculation
%
